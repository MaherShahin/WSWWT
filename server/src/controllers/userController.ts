...
export class UserController {
  ...
  static update = handleApiResponse(async (req: Request, res: Response, next: NextFunction) => {
  ...
  static delete = handleApiResponse(async (req: Request, res: Response, next: NextFunction) => {
  ...
  static getUserById = handleApiResponse(async (req: Request, res: Response, next: NextFunction) => {
  ...
  static getUserRooms = handleApiResponse(async (req: Request, res: Response, next: NextFunction) => {
  ...
  static searchUsers = handleApiResponse(async (req: Request, res: Response, next: NextFunction) => {
